...
<!-- endbuild -->
<@layout activebar="build" html_title="新订单">
        ...
        <form class="form-horizontal save" id="saveForm" role="form" action="/order/save" method="post">
                ...
                <div class="col-sm-7">
                    <select  name="order.address_id">
                        <#if addresses?? && addresses?size gt 0>
                            ...
                            <option value="${address.id}" <#if address.is_default==1 >selected="selected" </#if>>${address.name}</option>
                            </#list>
                        </#if>
                        <option value="">请选择</option>
                    </select>
            ...
            <#--</div>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <button id="newadrBtn" type="button" class="btn btn-default">保存地区</button>
