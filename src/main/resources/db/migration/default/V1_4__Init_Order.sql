...
VALUES (1,'东北区','',current_timestamp),
       (2,'华北区','',current_timestamp);
...
VALUES (1,'总行营业部',0,1,'9A01','',current_timestamp),
       ...
       (3, '北京阜成门支行', 1, 2, '103', '', current_timestamp),
       (4, '北京建国门支行', 1, 2, '104', '', current_timestamp),
       (5, '北京中关村支行', 1, 2, '105', '', current_timestamp),
       ...
       (10, '北京上地支行', 1, 2, '110', '', current_timestamp),
       (11, '北京西客站支行', 1, 2, '111', '', current_timestamp),
       ...
       (23, '北京西直门支行', 1, 2, '123', '', current_timestamp),
       ...
       (30, '北京西单支行', 1, 2, '130', '', current_timestamp),
       ...
       (42, '北京航天桥支行', 1, 2, '142', '', current_timestamp),
