...
VALUES (1,'管理员目录','P_D_ADMIN','/admin/**','',0,1,6,current_timestamp),
       (2,'角色权限管理','P_ROLE','/admin/role/**','',1,2,3,current_timestamp),
       (3,'用户管理','P_USER','/admin/user/**','',1,4,5,current_timestamp),
       (4,'总部目录','P_D_MEMBER','/member/**','',0,7,8,current_timestamp),
       (5,'分部目录','P_D_USER','/user/**','',0,9,12,current_timestamp),
       (6,'用户处理','P_USER_CONTROL','/user/branch**','',5,10,11,current_timestamp),
       (7,'订单','P_ORDER','/order/**','',0,13,22,current_timestamp),
       (8,'订单处理','P_ORDER_CONTROL','/order/deliver**','',7,14,15,current_timestamp),
       (9,'订单更新','P_ORDER_UPDATE','/order/update**','',7,16,17,current_timestamp),
       (10,'支部订单','P_ORDER_BRANCH','/order/branch**','',7,18,19,current_timestamp),
       (11,'区域支行处理','P_REGION_CONTROL','/order/region**','',7,20,21,current_timestamp),
       (12,'收货地址','P_Address','/address/**','',0,23,24,current_timestamp);
